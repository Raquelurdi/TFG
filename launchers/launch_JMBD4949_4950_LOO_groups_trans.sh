...
path=work_JMBD4949_4950_loo_groups_trans_12classes
for try in $trys; do
    for ngf in "${ngfs[@]}"; do
        for numfeat in $numfeats; do
            python main.py --epochs 500 --work_dir works_JMBD4949_4950_loo_groups_trans_12clases/work_${ngf}_numFeat${numfeat} \
